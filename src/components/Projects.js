        ...
        <div className="flex flex-wrap -m-4">
          {projects.map((project) => (
            <a
              ...
              <div className="flex relative project-tile">
                <img
                  alt="gallery"
                  className="absolute inset-0 w-full h-full object-cover object-center"
                  src={project.image}
                />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100 project-desc">
                  <div className="inner-wrap">
                    <h1 className="title-font font-medium text-white mb-3 project-title">
                      {project.title}
                    </h1>
